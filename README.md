...
- [CSFloat-Auto-Trade-Patched](https://github.com/redlfox/CSFloat-Auto-Trade-Patched) - Patched fork of [CSFloat-Auto-Trade](https://github.com/gradinazz/CSFloat-Auto-Trade). Added more functionality.
